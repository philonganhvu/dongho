/**
 * Created by HuuHai on 08/09/2016.
 */
...
function init() {
    ...
    function findHeadShot(key) {
        if (key < 0 || key > 17) return "images/HSnopic.png"; // There are only 16 images on the server
    ...
    var nodeDataArray = [
        { key: 0, name: "George V", gender: "M", birthYear: "1865", deathYear: "1936", chong: "1910-1936" },
        { key: 1, parent: 0, name: "Edward VIII", gender: "M", birthYear: "1894", deathYear: "1972", vo: "Nguyễn Thị Lan" },
        { key: 2, parent: 0, name: "George VI", gender: "M", birthYear: "1895", deathYear: "1952", chong: "Đào Trọng Thật" },
        { key: 7, parent: 2, name: "Elizabeth II", gender: "F", birthYear: "1926", chong: "Nguyễn Chánh Tín" },
